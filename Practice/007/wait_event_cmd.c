...
static void __exit exit_function(void)
{
    //Correct order (reverse of what you did in init):
...
void func1(void)
{
    pr_info("Func1 called\n");
}
void func2(void)
{
    pr_info("Func2 called\n");
}
static int ThreadFunction(void *unused)
{
     while (!kthread_should_stop())
    {
        ...
        wait_event_cmd(wait_queue_ex,wait_value!=0||kthread_should_stop(),func1(),func2());
